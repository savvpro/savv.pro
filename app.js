...
(function () {
  ...
  const CMDS = [
    ...
    { id: "go-doctrines", label: "Doctrines · library", hint: "github · library", href: "https://github.com/savvpro/savvpro-website/tree/main/library", group: "External", ext: true },
    { id: "go-repo", label: "Open repo on GitHub", hint: "github.com/savvpro/savvpro-website", href: "https://github.com/savvpro/savvpro-website", group: "External", ext: true },
  ...
  function wireConsoleGreeting() {
    const lines = [
      ...
      "  source repo:   github.com/savvpro/savvpro-website",
      "",
      "Library (the published documents):",
      "  github.com/savvpro/savvpro-website/tree/main/library",
      "",
