  ...
  return (
    ...
    >
      ...
      <section className="relative mx-6 overflow-hidden rounded-[32px] bg-[#070b14] px-[120px] py-20 text-white">
        ...
        <h2 className="mb-14 max-w-[700px] text-[56px] uppercase leading-[1.0] [font-family:Montserrat,sans-serif]">
        ...
        <div className="grid grid-cols-3 gap-5">
          {services.map(([id, title, text]) => (
            ...
            >
              ...
              <h3 className="mb-4 text-[26px] leading-[1.15] [font-family:Montserrat,sans-serif]">{title}</h3>
      ...
      <section className="bg-white px-[120px] py-20">
        ...
        <h2 className="mb-2 text-[46px] leading-[1.05] [font-family:Montserrat,sans-serif]">How We Work</h2>
        ...
        <div className="grid grid-cols-5 gap-4">
          {process.map(([id, title, text], i) => (
            ...
            >
              ...
              <h3 className="mb-3 text-[22px] leading-[1.1] [font-family:Montserrat,sans-serif]">{title}</h3>
      ...
      <section className="bg-white px-[120px] pb-24">
        <article className="relative overflow-hidden rounded-[24px] bg-[#1f2327] px-12 py-14 text-white">
          ...
          <h2 className="mb-4 max-w-[700px] text-[44px] uppercase leading-[1.0] [font-family:Montserrat,sans-serif]">
            Need a specific AI operating model?
          </h2>
          <p className="mb-10 max-w-[640px] text-[17px] leading-[1.75] text-white/70 [font-family:Poppins,sans-serif]">
